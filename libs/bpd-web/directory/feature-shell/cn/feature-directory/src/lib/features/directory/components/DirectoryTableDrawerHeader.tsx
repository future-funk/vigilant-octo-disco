...
interface DirectoryTableDrawerHeaderProps extends IHeaderParams {
  menuIcon?: ReactElement
}

const DirectoryTableDrawerHeader: FC<DirectoryTableDrawerHeaderProps> = (
  props
) => {
...
export default DirectoryTableDrawerHeader
