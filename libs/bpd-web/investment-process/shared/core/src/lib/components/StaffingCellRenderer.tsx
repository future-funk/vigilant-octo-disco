...
export interface StaffingCellRendererProps
  extends BpdStaffingWorkloadCellRendererProps {
  data: DealDto
}

export const StaffingCellRenderer: FC<StaffingCellRendererProps> = (props) => {
  const { data } = props
  const { totalCommitmentHours: totalCommitment, staffs } = data
